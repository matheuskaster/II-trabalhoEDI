...
/// @param g É um ponteiro que aponta para a forma.
/// @param dx É a distãncia que será somada a posição da forma que originou o clone no eixo 'x', para encontrar a posição que o clone se encontrará.
/// @param dy É a distância que será somada a posição da forma que originou o clone no eixo 'y', para encontrar a posição que o clone se encontrará.
